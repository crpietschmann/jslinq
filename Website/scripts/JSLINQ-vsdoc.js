...
JSLINQ.prototype = {
    ...
    Select: function (clause) {
        ...
        /// <param name="clause">The clause used to determine what values to select. Or a comma delimited string containing the object properties to select.</param>
        /// <returns type="JSLINQ"></returns>
    },
    ...
    Each: function (clause) {
        /// <summary>Executes a clause predicate on each element.</summary>
        /// <param name="clause">The clause to execute on each element.</param>
    },
    Random: function (count) {
        /// <summary>This method will returns the specified number of elements at random. If no number is specified, then 1 is returned.</summary>
        /// <param name="count">The number of elements to return</param>
    }
};